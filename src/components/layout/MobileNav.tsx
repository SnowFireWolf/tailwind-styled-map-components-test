    ...
    <React.Fragment>
      <Box sx="w-full h-full wrapper">
        <Box sx="fixed bottom-0 flex justify-center w-full transition-shadow bg-white border md:px-10 hover:shadow-xl">
          <Box sx="px-5 cursor-pointer md:px-8 hover:bg-gray-100">
            <Link sx="flex flex-col py-2 text-gray-700 md:w-20 items-center">
              <Box sx="flex justify-center w-full">
                <Svg sx="w-10 h-10 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"
          ...
          <Box sx="px-5 cursor-pointer md:px-8 hover:bg-blue-100">
            <Link sx="flex flex-col py-2 text-blue-500 md:w-20 active items-center">
              <Box sx="flex justify-center w-full">
                <Svg sx="inline-block w-10 h-10 text-center md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"
